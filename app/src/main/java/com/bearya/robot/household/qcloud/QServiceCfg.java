package com.bearya.robot.household.qcloud;
...
public class QServiceCfg {
    ...
    /** 腾讯云 cos 服务的 appid */
    private final String appid = "1254265966";

    /** appid 对应的 秘钥 */
    private final String secretId = "AKIDLejjltlPVTOn5DuvsjVD2o0EoFqVdzvL";

    /** appid 对应的 秘钥 */
    private final String secretKey = "fSKHOTkDbv35Je3f8jEg5Kfsv0CFENh8";

    /** bucketForObjectAPITest 所处在的地域 */
    private String region = Region.AP_Shanghai.getRegion();
    /** bucketForObjectAPITest 所处在的地域 */
    public final static String bucket = "beiya";
