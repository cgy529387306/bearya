package com.bearya.robot.household.media;

import com.bearya.robot.household.videoCall.AgoraCalculateHelp;
...
public class DynamicKeyUtil {
    ...
    public static String generateFinalDynamicKey(String channel, long uid) throws Exception {
        int ts = (int) (new Date().getTime() / 1000);
        int r = new Random().nextInt();
        int expiredTs = 0;

        return DynamicKey4.generateMediaChannelKey(AgoraCalculateHelp.appID, AgoraCalculateHelp.certificate, channel, ts, r, uid, expiredTs);
    }
