 ...
 * Generally there is one center item and bellow this item there are maximum {@link com.azoft.carousellayoutmanager.CarouselLayoutManager#getMaxVisibleItems()} items on each side of the center
 * item. By default {@link com.azoft.carousellayoutmanager.CarouselLayoutManager#getMaxVisibleItems()} is {@link com.azoft.carousellayoutmanager.CarouselLayoutManager#MAX_VISIBLE_ITEMS}.<br />
 * <br />
 * This LayoutManager supports only fixedSized adapter items.<br />
 * <br />
 * This LayoutManager supports {@link com.azoft.carousellayoutmanager.CarouselLayoutManager#HORIZONTAL} and {@link com.azoft.carousellayoutmanager.CarouselLayoutManager#VERTICAL} orientations. <br />
 * <br />
 ...
 * So like layout_height is not {@link ViewGroup.LayoutParams#MATCH_PARENT} for {@link com.azoft.carousellayoutmanager.CarouselLayoutManager#VERTICAL}<br />
 * <br />
 */
...
public class CarouselLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    /**
     * Setup {@link com.azoft.carousellayoutmanager.CarouselLayoutManager.PostLayoutListener} for this LayoutManager.
    ...
    private void fillChildItem(final int start, final int top, final int end, final int bottom, @NonNull final LayoutOrder layoutOrder, @NonNull final RecyclerView.Recycler recycler, final int i, final boolean childMeasuringNeeded) {
        ...
        if (null == transformation) {
            ...
            Log.d("NewScale", "transformation.mScaleX = "+transformation.mScaleX+ " transformation.mTranslationX = "+transformation.mTranslationX);
            Log.d("NewScale", "transformation.mScaleY = "+transformation.mScaleY+ " transformation.mTranslationY = "+transformation.mTranslationY);
